...
export class DataManager {
     ...
     */
    public saveChanges(
        changes: Object, key?: string, tableName?: string | Query, query?: Query): Promise<Object> | Object {
        ...
        let req: Object = this.adaptor.batchRequest(this, changes, args, query);
    ...
    public update(keyField: string, value: Object, tableName?: string | Query, query?: Query): Object | Promise<Object> {
        ...
        let res: Object = this.adaptor.update(this, keyField, value, tableName, query);
