    ...
    (function (Input) {
        ...
        function wireClearBtnEvents(element, button, container) {
            button.addEventListener('click', function (event) {
                var state = element.classList.contains(CLASSNAMES.DISABLE) || element.readOnly ||
        ...
        function setValue(value, element, floatLabelType, clearButton) {
            ...
            if (!ej2_base_1.isNullOrUndefined(clearButton) && clearButton && !element.nextSibling.classList.contains('e-clear-icon')) {
                ...
                if (element.value && !element.nextSibling.classList.contains('e-clear-icon')) {
                    ej2_base_1.removeClass([button], CLASSNAMES.CLEARICONHIDE);
                }
                else {
                    ej2_base_1.addClass([button], CLASSNAMES.CLEARICONHIDE);
