...
export function createSpinner ( args: SpinnerArgs): void {
    let radius: number;
    let container: { wrap: HTMLElement, inner_wrap: HTMLElement } = create_spinner_container(args.target);
...
function createLabel(container: HTMLElement, label: string) : HTMLElement {
    let labelEle: HTMLElement = document.createElement('div');
...
function createMaterialSpinner(container: HTMLElement, radius: number): void {
...
function createFabricSpinner(container: HTMLElement, radius: number): void {
    let uniqueID: string = random_generator();
...
function createHighContrastSpinner(container: HTMLElement, radius: number): void {
    let uniqueID: string = random_generator();
...
function setTheme(theme: string, container: HTMLElement, radius: number): void {
...
function createBootstrapSpinner(innerContainer: HTMLElement, radius: number): void {
    let uniqueID: string = random_generator();
...
function create_bootstrap_element(innerContainer: HTMLElement, uniqueID: string): void {
...
function create_fabric_element ( innerContainer: HTMLElement, uniqueID: string, themeClass: string ): void {
...
function create_material_element ( innerContainer: HTMLElement, uniqueID: string ): void {
...
function create_spinner_container(target: HTMLElement): { wrap: HTMLElement, inner_wrap: HTMLElement} {
    let spinnerContainer: HTMLElement = document.createElement('div');
    spinnerContainer.classList.add(CLS_SPINWRAP);
    let spinnerInnerContainer: HTMLElement = document.createElement('div');
...
export function setSpinner(args: SetSpinnerArgs): void  {
    ...
    for (let index: number = 0; index < container.length; index++) {
        ensureTemplate(args.template, (<HTMLElement>container[index]), args.type, args.cssClass);
    }
}

function ensureTemplate ( template: string, container: HTMLElement, theme: string, cssClass: string): void {
...
function replaceTheme( container: HTMLElement, theme: string, cssClass: string): void {
