import { Component, Property, ChildProperty, Event, BaseEventArgs } from '@syncfusion/ej2-base';
...
export class Tooltip extends Component<HTMLElement> implements INotifyPropertyChanged {
    ...
    private renderCloseIcon(): void {
        ...
        let tipClose: HTMLElement = createElement('div', { className: ICON + ' ' + CLOSE });
        ...
        for (let prop of Object.keys(newProp)) {
            switch (prop) {
                ...
                case 'tipPointerPosition':
                    let trgt: HTMLElement = document.querySelector('[data-tooltip-id= ' + this.ctrlId + '_content]') as HTMLElement;
